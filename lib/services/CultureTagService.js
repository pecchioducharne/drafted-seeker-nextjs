...
Example format:
- Leadership: ${firstName} shows strong initiative in leading team projects and mentoring others.
- Innovation: ${firstName} demonstrates creative problem-solving when tackling complex challenges.
- Teamwork: ${firstName} collaborates effectively with diverse teams and values different perspectives.
- Fast Learning: ${firstName} quickly adapts to new technologies and thrives in dynamic environments.

IMPORTANT: Each explanation MUST include ${firstName}'s name to make it personal and specific to them.
...
`;
    ...
    // Personalize descriptions (replace generic terms with name)
