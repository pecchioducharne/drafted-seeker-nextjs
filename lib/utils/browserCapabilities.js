...
export const checkScreenRecordingSupport = () => {
  ...
  if (userAgent.includes('safari') && !userAgent.includes('chrome')) {
    ...
    return {
      ...
      message: '⚠️ Safari has limited screen recording support. For best results, we recommend using Chrome or Firefox.',
  ...
  try {
    ...
    if (error.name === 'NotAllowedError') {
      return {
        granted: false,
        denied: true,
        message: '😅 Oops! We need screen sharing permission to record. Click \'Start Recording\' and allow access when prompted.',
        error: error
      };
